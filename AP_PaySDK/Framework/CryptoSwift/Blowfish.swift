...
//
 ...
 final class Blowfish {
  ...
  let keySize: Int
     ...
     let padding: Padding
     var decryptWorker: CipherModeWorker!
     var encryptWorker: CipherModeWorker!

     let N = 16 // rounds
     var P: Array<UInt32>
     var S: Array<Array<UInt32>>
     let origP: Array<UInt32> = [
  ...
  init(key: Array<UInt8>, blockMode: BlockMode = CBC(iv: Array<UInt8>(repeating: 0, count: Blowfish.blockSize)), padding: Padding) throws {
     ...
     func setupBlockModeWorkers() throws {
     ...
     func expandKey(key: Array<UInt8>) {
        var j = 0
        for i in 0..<(N + 2) {
            var data: UInt32 = 0x0
            for _ in 0..<4 {
    ...
    ///   - l: left half
    ///   - r: right half
        func encryptBlowfishBlock(l: inout UInt32, r: inout UInt32) {
        var Xl = l
        var Xr = r
    ...
    ///   - l: left half
    ///   - r: right half
        func decryptBlowfishBlock(l: inout UInt32, r: inout UInt32) {
        var Xl = l
        var Xr = r
