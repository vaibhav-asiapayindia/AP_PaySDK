...
//
 ...
 class CBCMAC: Authenticator {
  enum Error: Swift.Error {
     ...
     static let Zero: Array<UInt8> = [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]
     static let Rb: Array<UInt8> = [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x87]
  ...
  init(key: Array<UInt8>) throws {
     ...
     */
     func leftShiftOneBit(_ bytes: Array<UInt8>) -> Array<UInt8> {
