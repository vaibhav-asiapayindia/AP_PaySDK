...
//
 ...
 final class Rabbit: BlockCipher {
  ...
  var keySize: Int {
    ...
    /// State variables
     var x = Array<UInt32>(repeating: 0, count: 8)

    /// Counter variables
     var c = Array<UInt32>(repeating: 0, count: 8)
