...
SWIFT_PROTOCOL("_TtP9AP_PaySDK18ults_Customization_")
@protocol ults_Customization
...
SWIFT_PROTOCOL("_TtP9AP_PaySDK24ults_ButtonCustomization_")
@protocol ults_ButtonCustomization <ults_Customization>
...
@interface Customization : NSObject <ults_Customization>
...
@interface ButtonCustomization : Customization <ults_ButtonCustomization>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_PROTOCOL("_TtP9AP_PaySDK23ults_LabelCustomization_")
@protocol ults_LabelCustomization <ults_Customization>
...
@interface LabelCustomization : Customization <ults_LabelCustomization>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
- (nonnull instancetype)initWithChannelType:(enum PayChannel)channelType envType:(enum EnvType)envType amount:(NSString * _Nonnull)amount payGate:(enum PayGate)payGate currCode:(enum currencyCode)currCode payType:(enum payType)payType orderRef:(NSString * _Nonnull)orderRef payMethod:(enum payMethod)payMethod lang:(enum Language)lang merchantId:(NSString * _Nonnull)merchantId remark:(NSString * _Nonnull)remark extraData:(NSDictionary<NSString *, id> * _Nullable)extraData OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_PROTOCOL("_TtP9AP_PaySDK25ults_TextBoxCustomization_")
@protocol ults_TextBoxCustomization <ults_Customization>
...
@interface TextBoxCustomization : Customization <ults_TextBoxCustomization>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC9AP_PaySDK13ThreeDSParams")
...
SWIFT_PROTOCOL("_TtP9AP_PaySDK25ults_ToolbarCustomization_")
@protocol ults_ToolbarCustomization <ults_Customization>
- (BOOL)setBackgroundColor:(NSString * _Nonnull)hexColorCode error:(NSError * _Nullable * _Nullable)error;
...
@interface ToolbarCustomization : Customization <ults_ToolbarCustomization>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
enum ults_ButtonType : NSInteger;

SWIFT_PROTOCOL("_TtP9AP_PaySDK20ults_UiCustomization_")
@protocol ults_UiCustomization
- (BOOL)setButtonCustomization:(id <ults_ButtonCustomization> _Nonnull)buttonCustomization :(enum ults_ButtonType)buttonType error:(NSError * _Nullable * _Nullable)error;
- (BOOL)setToolbarCustomization:(id <ults_ToolbarCustomization> _Nonnull)toolbarCustomization error:(NSError * _Nullable * _Nullable)error;
- (BOOL)setLabelCustomization:(id <ults_LabelCustomization> _Nonnull)labelCustomization error:(NSError * _Nullable * _Nullable)error;
- (BOOL)setTextBoxCustomization:(id <ults_TextBoxCustomization> _Nonnull)textBoxCustomization error:(NSError * _Nullable * _Nullable)error;
- (id <ults_ButtonCustomization> _Nullable)getButtonCustomization:(enum ults_ButtonType)buttonType error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (id <ults_ToolbarCustomization> _Nullable)getToolbarCustomizationAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (id <ults_LabelCustomization> _Nullable)getLabelCustomizationAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (id <ults_TextBoxCustomization> _Nullable)getTextBoxCustomizationAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC9AP_PaySDK15UiCustomization")
@interface UiCustomization : NSObject <ults_UiCustomization>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (BOOL)setButtonCustomization:(id <ults_ButtonCustomization> _Nonnull)buttonCustomization :(enum ults_ButtonType)buttonType error:(NSError * _Nullable * _Nullable)error;
- (BOOL)setToolbarCustomization:(id <ults_ToolbarCustomization> _Nonnull)toolbarCustomization error:(NSError * _Nullable * _Nullable)error;
- (BOOL)setLabelCustomization:(id <ults_LabelCustomization> _Nonnull)labelCustomization error:(NSError * _Nullable * _Nullable)error;
...
typedef SWIFT_ENUM(NSInteger, ults_ButtonType, open) {
  ults_ButtonTypeSUBMIT = 0,
  ults_ButtonTypeCONTINUE = 1,
  ults_ButtonTypeNEXT = 2,
  ults_ButtonTypeCANCEL = 3,
  ults_ButtonTypeRESEND = 4,
};
